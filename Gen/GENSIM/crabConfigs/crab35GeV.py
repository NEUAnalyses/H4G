...
config.General.requestName = 'GENSIM_GluGluToHToAATo4G_mA_35GeV_13TeV_Pythia8'
config.General.workArea = '/afs/cern.ch/work/r/rateixei/work/NEU_H4G/Mar23/CMSSW_7_6_1/src/crab_projects'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = '/afs/cern.ch/work/r/rateixei/work/NEU_H4G/Mar23/CMSSW_7_6_1/src/Configs/GENSIM_GluGluToHToAATo4G_mA_35GeV_Pythia8.py'

config.Data.outputPrimaryDataset = 'GluGluToHToAATo4G_mA_35GeV_13TeV_Pythia8'
